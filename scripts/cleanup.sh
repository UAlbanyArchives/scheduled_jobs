...
printf "\tMoving /patron files and directories older than 10 days to /expired\n"
...
printf "\tRemoving /patron/expired files and directories older than 20 days\n"
...
printf "\tMoving /SPE_Uploads files older than 7 days to /expired\n"
...
printf "\tRemoving /SPE_Uploads/expired files older than 14 days\n"
...
# Move non-expired files older than 7 days to /expired
printf "\tMoving /Bookeye Scans files older than 7 days to /expired\n"
find "/media/Library/Bookeye Scans" -mindepth 1 -maxdepth 1 -mtime +7 ! -name expired -exec mv {} "/media/Library/Bookeye Scans/expired/" \;

# Remove files in /expired older than 14 days
printf "\tRemoving /Bookeye Scans/expired files older than 14 days\n"
